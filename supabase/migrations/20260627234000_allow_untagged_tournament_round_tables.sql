-- Allow copied or manually created tournament tables to seed rounds before table tags are bound.
...
begin
  ...
  if ready_table_count < required_table_count then
    raise exception 'Add more tables before starting this round.'
      using errcode = 'P0001';
  end if;
