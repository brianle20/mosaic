-- Final hygiene for deprecated player-tag RPCs and live tournament start lint.
...
begin
  ...
  loop
    ...
    for seat_assignment_index in 1..array_length(assignment_rows, 1) loop
      ...
      values (
        session_row.id,
        assignment_rows[seat_assignment_index].seat_index,
        initial_winds[assignment_rows[seat_assignment_index].seat_index + 1],
