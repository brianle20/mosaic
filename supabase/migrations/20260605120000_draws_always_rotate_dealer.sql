-- Draw hands always rotate dealer; keep the legacy waiting column/API parameter
-- for compatibility, but remove it from current rule behavior.
...
begin
  ...
  minimum_fan := app_private.ruleset_minimum_fan(target_ruleset_id);
...
begin
  ...
  into legacy_draw_rotation_event;
