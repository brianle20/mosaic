-- Completed rounds may have their seating assignments cleared when the next
-- round is generated. Keep completed-round summaries anchored to those cleared
-- assignments so dashboards can still show historical round progress.
