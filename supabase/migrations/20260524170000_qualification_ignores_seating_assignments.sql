-- Qualification sessions are ad hoc open-play tables; generated seating only
-- becomes enforceable after qualification ends.
...
begin
  ...
  if not found
    or event_row.seating_mode = 'manual'
    or event_row.current_scoring_phase = 'qualification'
  then
    return;
  end if;
...
begin
  ...
  values (
    ...
    0,
    case
      when assignment_row.assignment_type = 'bonus' then 'bonus'
